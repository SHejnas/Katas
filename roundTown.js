/*
    ...
    Create a function sumMultiplyAndRound that takes 3 numbers. The function should sum the first two 
    numbers passed in, round them down to the nearest integer. 
...
function sumMultiplyAndRound(x,y,z) {
    let sumXY = Math.floor(x + y);
    return(Math.ceil(sumXY * z));
}
